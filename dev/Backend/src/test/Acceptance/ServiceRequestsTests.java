...
//        }
    ...
    public void GivenImageDTO_WhenConfigImage_ImageIsCorrect() {
        ...
        try {
            ...
            VariableModuleDTO variableModuleDTO = new VariableModuleDTO(Set.of("myVar"), Set.of("mySet"), Set.of(),Map.of("myVar",List.of("anonymous_set")));
    ...
    public void testSolve_Simple() {
        try {
            ...
            ImageDTO imageDTO=new ImageDTO(new VariableModuleDTO(Set.of("myVar"),Set.of(),Set.of(),Map.of()),Set.of(),Set.of());
