 ...
 */
public record SetDTO(@NotNull @Valid SetDefinitionDTO setDefinition,@NotNull @Valid List<@NotBlank @Size(max = 255, message = "Set values have be shorter then 255 characters") String> values) { }
